...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Summer Sale', description: 'Banner title', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateBannerDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Up to 50% off!', description: 'Banner description', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateBannerDto.prototype, "description", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: true, description: 'Is the banner active?', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 0, description: 'Sort order', required: false }),
