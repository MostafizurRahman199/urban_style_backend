    ...
    async create(createProductDto, files) {
        ...
        const product = await this.prisma.product.create({
            data: {
                ...
                deliveryCharge: createProductDto.deliveryCharge ?? 0,
    ...
    async update(id, updateProductDto) {
        ...
        return this.prisma.product.update({
            ...
            data: {
                ...
                ...(updateProductDto.deliveryCharge !== undefined ? { deliveryCharge: updateProductDto.deliveryCharge } : {}),
                ...
                ...(updateProductDto.videoUrl !== undefined && { videoUrl: updateProductDto.videoUrl }),
